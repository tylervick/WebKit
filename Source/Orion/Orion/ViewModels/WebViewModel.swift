...
extension WebViewModel: WKHistoryDelegate {
    func webView(_ webView: WKWebView!, didUpdateHistoryTitle title: String!, for URL: URL!) {
        logger.debug("didUpdateHistoryTitle:\(title ?? "") for:\(URL.absoluteString)")
    }
    
    func webView(_ webView: WKWebView!, didPerformClientRedirectFrom sourceURL: URL!, to destinationURL: URL!) {
        logger.debug("didPerformClientRedirectFrom:\(sourceURL.absoluteString) to:\(destinationURL.absoluteString)")
    }
    
    func webView(_ webView: WKWebView!, didPerformServerRedirectFrom sourceURL: URL!, to destinationURL: URL!) {
        logger.debug("didPerformServerRedirectFrom:\(sourceURL.absoluteString) to:\(destinationURL.absoluteString)")
    }
}
...
extension WebViewModel: WKNavigationDelegate {
    ...
    func receivedHistoryItemForWebView(for webView: WKWebView) {
